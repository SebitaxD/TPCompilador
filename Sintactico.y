...
factor : CONST_ENT                         {printf("\nREGLA 58: <factor>-->CONST_ENT\n");}
		...
		| PAR_A expresion PAR_C             {printf("\nREGLA 61: <factor>-->PAR_A <expresion> PAR_C\n");}
            | PAR_A expresion BETWEEN expresion PAR_C      {printf("\nREGLA 62: <factor>-->PAR_A <expresion> BETWEEN <expresion> PAR_C\n");}
            | PAR_A expresion INLIST expresion PAR_C       {printf("\nREGLA 63: <factor>-->PAR_A <expresion> INLIST <expresion> PAR_C\n");}
